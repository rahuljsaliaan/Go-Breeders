...
VALUES (
    ...
    (
        ...
        'Pixie cat, Alien cat, Poodle cat',
        'United Kingdom'
    ),
    (
        28,
    ...
    (
        ...
        'Canadian Hairless, Canadian Sphynx',
        'Canada'
    ),
    (
        63,
...
VALUES (
    ...
    (
        ...
        140,
        10,
        'Possesses a unique combination of Mastiff and gazehound characteristics (UKC).',
        '',
        ''
    ),
    (
    ...
    (
        ...
        60,
        13,
        'The Alaskan Husky is not considered a \"purebred\" dog like the Siberian Husky. Alaskan huskies are bred for speed primarily for dog sledding. Their genetic makeup generally includes a mix of Northern breeds including the Siberian Husky',
        '',
        ''
    ),
    (
    ...
    (
        ...
        120,
        11,
        'The American Bully breed developed as a natural extension of the American Pit Bull Terrier. (UKC)',
        '',
        'United States'
    ),
    (
    ...
    (
        ...
        12,
        '',
        'Louisiana Catahoula Leopared Dog',
        ''
    ),
    (
        447,
    ...
    (
        ...
        30,
        14,
        'FCI Classification: Group 8 Retrivers - Flushing Dogs - Water Dogs',
        '',
        ''
    ),
    (
    ...
    (
        ...
        65,
        14,
        'Among the world\'s oldest breeds the slim but rugged Saluki was the hunting hound of kings for thousands of years. Salukis are swift and agile sprinters who love a good chase. ',
        '',
        ''
    ),
    (
        ...
        65,
        13,
        'These dogs were kept by a native tribe to ancient Siberia known as the Samoyeds. The Samoyeds were used to pull sleds and herd reindeer.',
        '',
        ''
    ),
    (
    ...
    (
        ...
        19,
        13,
        'Well-suited for closed environments, the Schipperke is energetic and playful.',
        '',
        'Moorke'
    ),
    (
    ...
    (
        ...
        25,
        13,
        'The Sealyham Terrier was born of a desire to produce the perfect terrier. ',
        'Welsh Corgi',
        ''
    ),
    (
...
VALUES (
        ...
        'User',
        'admin@example.com',
        '$2a$14$lfQ071jRtaUB6lNXorl7mOjxIlNbla9MWnQJwnZz2n2PM8ML2Velu',
        1,
        30
    );
